...
export default function ConfirmationDialog({
  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      ...
      <AlertDialogContent className="w-[520px] max-w-[calc(100%-2rem)] rounded-[20px] border-2 border-[#AFAFAF] bg-white p-10 shadow-xl flex flex-col gap-10">
        <button
        ...
        <div className="flex flex-col items-center text-center gap-4 pt-2">
          ...
          <p className="text-[20px] font-medium leading-7 text-[#7F7F7F]">
            {description}
          </p>
        </div>
        ...
        <div className="flex justify-center gap-6">
          <Button
            ...
            variant="outline"
            onClick={() => onOpenChange(false)}
            className="h-12 rounded-xl border-[#D4D4D4] bg-[#ECECEC] px-7 text-lg font-semibold text-[#7F7F7F] hover:bg-[#E3E3E3]"
          >
            {cancelText}
          </Button>
          ...
          <Button
            ...
            disabled={loading}
            onClick={onConfirm}
            className={`h-12 rounded-xl px-7 text-lg font-semibold ${confirmButtonStyle}`}
          >
