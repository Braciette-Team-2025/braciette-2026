...
export default function VotingTextbox({ id, desc }: GuideItem) {
  return (
    <div className="group flex flex-col gap-0.5 md:gap-2 xl:gap-4 items-center transition-transform duration-300 hover:-translate-y-2">
